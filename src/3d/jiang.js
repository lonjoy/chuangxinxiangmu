...
ColladaTest.prototype = {
    ...
    load: function(gl) {
        ...
        //var daeSource = { url: "examples/data/0.dae", specular: [0.0, 0.0, 0.0, 0.0], light: true, eye: [0.0, 1.5, 1.5] };
    ...
    keyDown: function(gl, keyCode, keyString) {
        ...
        if (keyString == "a") {
            this.gldoc.sceneInfo.eye[0] += 0.1;
        }
        if (keyString == "d") {
            this.gldoc.sceneInfo.eye[0] -= 0.1;
        }
    ...
    draw: function(gl) {
        ...
        gl.clearColor(0.718, 0.823, 0.969, 1.0);
...
function changeScene(location) {
    ...
    var daeSource = { url: "webgl/dae/"+location+".dae", specular: [0.0, 0.0, 0.0, 0.0], light: true, eye: [0.0, 1.5, 1.5] };

    gColladaTest.loadDataset(daeSource);
}

sglRegisterCanvas("Jiang_Canvas", gColladaTest, 10.0);